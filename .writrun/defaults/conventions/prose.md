...
How documentation, skills and comments are written. Taste, not
machinery — no script reads this file, and a project that writes
...
[`settings.json`](../../../writrun/settings.json), and prose never restates it. A
