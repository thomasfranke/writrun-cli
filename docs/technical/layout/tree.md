...
| `internal/screen/` | Every key-navigated screen, and the header and footer they share. |
| `internal/drawing/` | One frame of a screen drawing, read back as the lines a terminal shows. |
