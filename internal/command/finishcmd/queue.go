...
// numOf keeps only the digits, so `finish spec-0012` would have worked
// task-0012 — a real task, about different work, carried to the write
// stage without a word. The two counters run independently and are
