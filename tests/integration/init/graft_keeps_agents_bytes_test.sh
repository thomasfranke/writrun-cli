...
# An existing AGENTS.md is grafted, every byte outside WritRun's
...
check "WritRun's section is now in place" 0 ".writrun/AGENTS.md" \
  -- grep ".writrun/AGENTS.md" AGENTS.md
